...
class HPCJobMonitor:
    ...
    def create_widgets(self):
        ...
        self.host_entry.insert(0, "hostname") # Edit: Put the hostname here
        ...
        self.user_entry.insert(0, "username") # Edit: Put your username here
    ...
    def monitor_loop(self):
        while self.running:
            ...
            try:
                ...
                if not output or len(output.strip().splitlines()) < 3: # Is this second condition necessary?
                    jobs = []
